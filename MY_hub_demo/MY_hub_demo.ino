...
void setup()
{
  ...
  while (!Serial); // Wait for serial port to connect - used on Leonardo, Teensy and [MEGA ADK?] with built-in USB CDC serial connection
#endif
  ...
  next_time = millis() + 10000;   // 10 sec between connection attempt
}
